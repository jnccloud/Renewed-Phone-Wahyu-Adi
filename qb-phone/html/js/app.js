    ...
    $.each(data.applications, function(i, app){
        ...
        if ((!app.job || app.job === QB.Phone.Data.PlayerJob.name) && !blockedapp) {
            ...
            if (app.app == "meos") {
                ...
                icon = '<img src="./img/apps/garage.png" style="width: 100%;">';
            } else if (app.app == "twitter"){
                icon = '<img src="./img/apps/twatter.png" style="width: 100%;">';
            } else if (app.app == "whatsapp"){
                icon = '<img src="./img/apps/messages.png" style="width: 100%;">';
                ...
                icon = '<img src="./img/apps/invoice.png" style="width: 100%;">';
                ...
                icon = '<img src="./img/apps/discord.png" style="width: 100%;">';
            } else if (app.app == "documents"){
                icon = '<img src="./img/apps/documents.png" style="width: 100%;">';
            } else if (app.app == "job"){
                icon = '<img src="./img/apps/job.png" style="width: 100%;">';
            }
