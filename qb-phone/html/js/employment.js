...
function changePage(){
    ...
    var HeaderOption = 
    '<span id="employment-search-text">Employment</span>'+
...
$(document).on('click', '.employment-list', function(e){
    ...
    $.post('https://qb-phone/GetEmployees', JSON.stringify({job: job}), function(data){
        for (const [k, v] of Object.entries(data)) {
            ...
            if (QB.Phone.Data.PhoneJobs[job].grades[grade].isboss){
                var AddOption = 
                '<div class="employment-job-list" data-csn='+v.cid+' data-job='+job+'><span class="employment-job-icon"><i class="'+icon+'"></i></span>' +
    ...
    var HeaderOption = 
    // '<span id="employment-job-search-text">Search</span>' +
