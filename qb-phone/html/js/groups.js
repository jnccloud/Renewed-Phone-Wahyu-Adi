    ...
    $.post('https://qb-phone/jobcenter_CheckPlayerNames', JSON.stringify({
        id: id,
           ...
           $("#phone-new-box-main-playername").html("");
            for (const [k, v] of Object.entries(Data)) {
                var AddOption = `<div class="group-member casino-text-clear icon"><div style="position: absolute;"><i class="fas fa-user" style="font-size: 1vh; margin-left: 15px; margin-top: 10px;"></i></div class="jobcenter-playerlist-name" style="color: black;"><div class="jobcenter-playerlist-name">${v}</div></div>`
